...
COI2 <- read.csv(COI.asvs[2])

COI3 <- read.csv(COI.asvs[3])
...
COI5 <- read.csv(COI.asvs[5])

COI6 <- read.csv(COI.asvs[6])
...
COI.ASV.table <- bind_rows(COI1, COI2, COI3, COI4, COI5, COI6, COI7)
...
MiFish5 <- read.csv(MiFish.asvs[5])
MiFish6 <- read.csv(MiFish.asvs[6])
...
MiFish7 <- read.csv(MiFish.asvs[7])
MiFish7 <- MiFish7 %>% 
  separate(Sample_name, into=c("marker","date","creek","site","bio_rep"), remove = TRUE) %>%  # separate sample names 
  unite("Sample_name", c("marker","date","creek","site","bio_rep"), sep=".", remove=TRUE)
  

MiFish.ASV.table <- bind_rows(MiFish.ASV.table, MiFish4, MiFish5, MiFish6, MiFish7)
