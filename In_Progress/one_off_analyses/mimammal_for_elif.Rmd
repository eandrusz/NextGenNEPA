---
title: "MiMammal_visualizing_for_elif"
author: "Eily Allan"
date: "11/17/2021"
...
metadata <- metadata %>% filter(Locus == "MiMammal") 
# for some reason missing 1???
metadata <- metadata[-100,]

ASV.table <- read.csv("/Users/elizabethandruszkiewicz/GoogleDrive/UW/GitHub/NextGenNEPA/Output/dada2_output_files/20211117.MiMammal.merged.ASV.table.csv")

# check that all samples are in ASV.table as in metadata file
dim(metadata)[1] == length(unique(ASV.table$Sample_name))
setdiff(metadata$Sample_ID, ASV.table$Sample_name)
# the extra is a kangaroo so let's ignore it for now bc we will remove it

Hash.key <- read.csv("/Users/elizabethandruszkiewicz/GoogleDrive/UW/GitHub/NextGenNEPA/Output/dada2_output_files/20211117.MiMammal.hash.key.csv")
...
run2.classif <- readRDS("/Users/elizabethandruszkiewicz/GoogleDrive/UW/GitHub/NextGenNEPA/Output/hashes_to_taxonomy_output/run2/mimammal/hashes.annotated.rds")
run2.2.classif <- readRDS("/Users/elizabethandruszkiewicz/GoogleDrive/UW/GitHub/NextGenNEPA/Output/hashes_to_taxonomy_output/run2_rerun/MiMammal/hashes.annotated.rds")
run2.3.classif <- readRDS("/Users/elizabethandruszkiewicz/GoogleDrive/UW/GitHub/NextGenNEPA/Output/hashes_to_taxonomy_output/run2_rerun_crux/MiX/hashes.annotated.rds")
...
big.key <- rbind(run2.classif, run2.2.classif, run2.3.classif, run3.classif, run4.classif)
...
ggplot(raw.pca.to.plot, aes(x=pca.raw.bc.MDS1, y=pca.raw.bc.MDS2)) +
  ...
  ggtitle('MiMammal - Raw reads combined to taxa - Bray Curtis')
...
ggsave(file="/Users/elizabethandruszkiewicz/GoogleDrive/UW/GitHub/NextGenNEPA_EA/Output/MiMammal.allruns.taxalevel.visual.anova.png", dpi = "retina")
