...
ASV.table <- read.csv("/Users/elizabethandruszkiewicz/GoogleDrive/UW/GitHub/NextGenNEPA/Output/dada2_output_files/20211111.COI.merged.ASV.table.csv")

# check that all samples are in ASV.table as in metadata file
dim(metadata)[1] == length(unique(ASV.table$Sample_name))

Hash.key <- read.csv("/Users/elizabethandruszkiewicz/GoogleDrive/UW/GitHub/NextGenNEPA/Output/dada2_output_files/20211111.COI.hash.key.csv")
