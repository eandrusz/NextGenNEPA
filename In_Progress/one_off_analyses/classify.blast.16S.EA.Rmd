...
blast_file <- paste0(run_marker_output_folder,"/Prelim16s_ac_20210527.txt")

blast_result <- read_delim(blast_file, col_names = c("qseqid", "sacc", "pident", "length", "mismatch", "gapopen",  "qstart", "qend", "sstart", "send", "evalue", "bitscore"), delim = "\t" )
