...
Hash_key <- read.csv("/Users/elizabethandruszkiewicz/GoogleDrive/UW/GitHub/NextGenNEPA/Output/dada2_output_files/runs1_2_3_coi_hash_key.csv")

Hash_key <- Hash_key[,2:3]
```
...
cutadapt_metadata <- metadata_input_run2_fix

 is.backwards <- (cutadapt_metadata$PrimerF == "TANACYTCNGGRTGNCCRAARAAYCA")
 samples.backwards <- cutadapt_metadata$direction[is.backwards]
 samples.forwards <- cutadapt_metadata$direction[! is.backwards]
# 
 ASVs.fwd <- ALL.ASVs %>%
