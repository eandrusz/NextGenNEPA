...
outputfolder <- paste0(here("Output","cutadapt_output"),"/run",params$run.num,"_",format(Sys.Date(), "%Y%m%d"))
...
bash test.bash.sh /Users/elizabethandruszkiewicz/GoogleDrive/UW/GitHub/NextGenNEPA_EA/Output/cutadapt_output/run1_20211117/params.txt
```
