...
blast.file <- paste0(here("Output","classification_output"),"/rs/", marker,"/Rosetta_mifish.txt")
...
writeXStringSet(seqs.for.fasta, file=here("In_Progress","rosetta_calibration","output","salmon_seqs.fasta"))
