...
params: 
  folder:
    value: /Users/elizabethandruszkiewicz/GoogleDrive/UW/GitHub/NextGenNEPA_EA/Output/classification_output/run1_20211117/MiFish
  Hash_key:
    value: /Users/elizabethandruszkiewicz/GoogleDrive/UW/GitHub/NextGenNEPA_EA/Output/dada2_output/run1_20211117/MiFish/hash_key.csv
  ASVs: 
    value: /Users/elizabethandruszkiewicz/GoogleDrive/UW/GitHub/NextGenNEPA_EA/Output/dada2_output/run1_20211117/MiFish/ASV_table.csv
  classifier:
...
saveRDS(good.clasif.hashes, file=paste0(here("Output","classification_output"),"/",format(Sys.Date(), "%Y%m%d"), ".", params$marker,".all.gs.previous.hashes.annotated.rds"))
good.clasif.hashes <- readRDS(file=paste0(here("Output","classification_output"),"/",format(Sys.Date(), "%Y%m%d"), ".", params$marker,".all.gs.previous.hashes.annotated.rds"))
write.csv(good.clasif.hashes, file=paste0(here("Output","classification_output"),"/",format(Sys.Date(), "%Y%m%d"), ".", params$marker,".all.gs.previous.hashes.annotated.csv"))
...
# write both of these to fasta files to blast
hash.to.blast <- Hash %>% 
