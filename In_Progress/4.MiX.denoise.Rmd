...
metadata <- read.csv("/Users/elizabethandruszkiewicz/GoogleDrive/UW/GitHub/NextGenNEPA_EA/Input/sequencing_metadata_files/master_sequencing_datasheet_20211026.csv")
ASV.table <- read.csv(here("Output", "dada2_output", "run2_20211117", "MiFish", "ASV_table.csv"))
