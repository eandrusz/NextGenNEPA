...
Note that the classifier is maintained by insect. We are using version 1, which was last updated on 20181111. Check here to see if there is a newer version: https://cran.r-project.org/web/packages/insect/vignettes/insect-vignette.html
