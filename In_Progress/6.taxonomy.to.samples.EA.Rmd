...
MiFish.ASV.table <- read_csv(paste0(here("Output", "dada2_output", "20220314.combined.MiFish.ASV.table.csv")))
...
write.csv(MiFish.by.species, here("Output","combined_species_tables","20220314_MiFish.csv"), row.names = FALSE)
