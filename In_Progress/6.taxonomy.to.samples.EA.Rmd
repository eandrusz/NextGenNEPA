...
COI.ASV.table <- read_csv(paste0(here("Output", "dada2_output", "20220401.combined.COI.ASV.table.csv")))
...
write.csv(COI.by.species, here("Output","combined_species_tables","20220401_COI.csv"), row.names = FALSE)
